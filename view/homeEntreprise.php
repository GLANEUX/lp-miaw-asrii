    ...
    <div class="row g-5 py-2">
        <div class="col-6">
            <div class="text-right py-3">
                <a href="#" class="bg-custom-purple txt-color-black button-font py-2 px-3 rounded">Ajouter</a>
            </div>
            <div class="bg-custom-black p-2 text-white">Contenu de la boîte 1</div>
            <div class="bg-white p-3">
                 <iframe src="<?= URL ?>/projets/list" frameborder="0"
