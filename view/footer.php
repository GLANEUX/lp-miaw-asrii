...
<footer>
  ...
  <div style="background: #101820;text-align:center">
    ...
    <div class="row row-with">
      ...
      <div class="col-md-3 mx-auto">
        ...
        <!-- LIENS -->
        <h3 class="font-weight-bold text-uppercase mt-3 mb-4" style="color:white; padding-top:12%;text-align:left">LIENS UTILES</h3>
      ...
      <div class="col-md-3 mx-auto">
        ...
        <a class="col-6 link-light link-offset-2 link-underline link-underline-opacity-0" href="#!"><i class="fa-brands fa-square-facebook fa-2xl" style="color: #9678d3;"></i></a>
        <a class="col-6 link-light link-offset-2 link-underline link-underline-opacity-0" href="#!"><i class="fa-brands fa-instagram fa-2xl" style="color: #9678d3;"></i></a>
        </div>
        <div class="row my-5 mx-5">
        <a class="col-6 link-light link-offset-2 link-underline link-underline-opacity-0" href="#!"><i class="fa-brands fa-linkedin fa-2xl" style="color: #9678d3;"></i></a>
        <a class="col-6 link-light link-offset-2 link-underline link-underline-opacity-0" href="#!"><i class="fa-brands fa-square-twitter fa-2xl" style="color: #9678d3;"></i></a>
        </div>
  ...
  <!-- Copyright -->
  <div class="footer-copyright text-center py-3" style="background-color: #e9e9e9;">© 2022-2023 CoopTeam -
    Copyright
    <a href="#"> </a>
