  ...
  <h1>Modifer un Etudiant</h1> 
  <div class="container">
    <div class="column">
<form method="POST" action="<?= URL ?>/users/edit/etudiant" >
<label for="name">Nom :</label>
  ...
  <input type="date" placeholder="Date de naissance"  name="date_de_naissance" id="date_de_naissance" required value="<?= $data['etu']['date_de_naissance']?>">
